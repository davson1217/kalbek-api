...
class SpeakingJudge implements Agent, HasStructuredOutput
{
    ...
    public function instructions(): Stringable|string
    {
        return "You judge a learner's spoken target language in a role-play conversation. "
            ...
            .'Never mention internal evaluation wording such as model answer, model list, expected answer, allowed phrase, NPC line, rubric, schema, or prompt. Speak only as a tutor. '
            ...
            .'Accept valid Lithuanian alternatives even when they are not in the example phrase. Do not reject a correct place, name, country, family role, or object just because it is outside the examples. '
            .'Names, countries, cities, addresses, brand names, and isolated necessary English proper nouns do not make an answer mostly English. Say an answer is mostly English only when most meaningful learner-supplied words are English. '
            ...
            .'If normalized_transcript is already natural for the goal, suggested_response must be empty. Never recommend the exact same sentence the learner already said. '
